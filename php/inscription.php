...
if(isset($_POST['creercompte'])){
    ...
    if ($mdp == $mdpc) {
        $requete = $bdd->prepare("INSERT INTO compte(nom_compte,prenom_compte,email_compte,numero_telephone ,mot_de_passe,type_compte)VALUES(?,?,?,?,?,?)");
        $requete->execute([$nom_compte, $prenom_compte,$email_compte,$numero_telephone,$mdp,$type_compte]);
